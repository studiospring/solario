...
Spork.prefork do
  ...
  RSpec.configure do |config|
    ...
    config.before(:each) do
      #stub_request(:get, "http://pvoutput.org/service/r2/search.jsp?country=Australia&key=&#{Rails.application.secrets.pvo_api_key}q=1234%2025km%20%2BN%2015%20tilt&sid=#{Rails.application.secrets.pvo_system_id}").
        #to_return(
          #:status => 200, 
      ...
      stub_request(:get, "http://pvoutput.org/service/r2/search.jsp?country=Australia&key=d4688e594b218f1746dec6cff0e34c2216dc675e&q=2031&sid=26011").
       with(:headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Ruby'}).
       to_return(:status => 200, :body => "", :headers => {})

      stub_request(:get, "http://pvoutput.org/service/r2/getsystem.jsp?key=#{Rails.application.secrets.pvo_api_key}&sid=#{Rails.application.secrets.pvo_system_id}").
        to_return(
          :status => 200, 
