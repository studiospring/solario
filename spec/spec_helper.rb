...
Spork.prefork do
  ...
  RSpec.configure do |config|
    ...
    config.before(:each) do
      ...
      stub_request(:get, "http://pvoutput.org/service/r2/getstatistic.jsp?date_from=20100901&date_to=20100930&key=#{Rails.application.secrets.pvo_api_key}&sid=#{Rails.application.secrets.pvo_api_key}&sid1=1000").
         with(:headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Ruby'}).
