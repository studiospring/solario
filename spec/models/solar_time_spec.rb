  ...
  describe 'class method' do
    describe 'b' do
      ...
      it "should return 'b' degrees for a given day" do
        @solar_time.b(10).should be_within(0.002).of(-1.222)
      end
    end
    describe 'EoT' do
      before { solar_time.eot(10) }
      it "should return the Equation of Time for a given day" do
        @solar_time.eot(10).should be_within(0.002).of(-7.499)
      end
    end
  ...
  describe 'instance method' do
    describe 'time correction factor' do
      ...
      it "should correct the time wrt day and position" do
        @solar_time.time_correction(10).should be_within(0.02).of(-67.499)
      end
    end
    describe 'to_lst' do# <<<
      before { @solar_time.to_lst(14, -67.499) }
      it "should convert local time to local solar time" do
        @solar_time.to_lst(14, -67.499).should be_within(0.01).of(12.88)
      end
    end# >>>
    describe 'hra' do
