  ...
  describe 'new page' do
    ...
    describe 'with invalid inputs' do
      ...
      describe "after submitting", :js => true do
        ...
        it do should have_selector("label.alert-warning",
                                   :text => "Please enter at least 4 characters.") end
        it do should have_selector("label.alert-warning",
                                   :text => "Please enter a value less than or equal to 360.") end
        it do should have_selector("label.alert-warning",
                                   :text => "This field is required.") end
        it do should have_selector("label.alert-warning",
                                   :text => "This field is required.") end
      end
